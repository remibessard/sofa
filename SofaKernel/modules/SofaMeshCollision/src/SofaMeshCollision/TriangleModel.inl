...
template<class DataTypes>
void TriangleCollisionModel<DataTypes>::computeTrianglesFlags()
{
...
{
    const sofa::core::topology::BaseMeshTopology::Triangle t = (*m_triangles)[i];
    int f = 0;
...
template<class DataTypes>
inline int TTriangle<DataTypes>::flags() const { return this->model->m_triangleFlags[index]; }
